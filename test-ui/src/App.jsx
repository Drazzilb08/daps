                ...
                <RouteErrorProvider>
                  <Routes>
                    <Route path="/" element={<Layout />}>
                      ...
                      <Route path="media" element={<div className="content-layout"><h1>Media</h1><p>Media management overview</p></div>} />
                      ...
                      <Route path="posters" element={<div className="content-layout"><h1>Posters</h1><p>Poster management overview</p></div>} />
