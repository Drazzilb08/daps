                        ...
                        <div className="page-error-boundary__content">
                            {pageDescription && (
                                <div className="page-error-boundary__description">
                                    <p>The {pageDescription} encountered an error and could not be displayed properly.</p>
                                </div>
                            )}
                            ...
                            <div className="page-error-boundary__error-details">
                                ...
                                <div className="page-error-boundary__error-message">
                                    <strong>Component Stack:</strong> {errorInfo?.componentStack?.split('\n').slice(0, 3).join('\n') || 'Not available'}
                                </div>
                                {retryCount > 0 && (
                                ...
                                <div className="page-error-boundary__timestamp">
                                    <strong>Time:</strong> {errorTimestamp ? new Date(errorTimestamp).toLocaleString() : 'Unknown'}
                                </div>
                            </div>
                            ...
                            <div className="page-error-boundary__actions">
                                ...
                                <button
                                    ...
                                    className={`page-error-boundary__button page-error-boundary__button--copy ${
                                        this.state.copySuccess ? 'page-error-boundary__button--success' : 
                                        this.state.copyError ? 'page-error-boundary__button--error' : ''
                                    }`}
                                    type="button"
                            ...
                            <div className="page-error-boundary__help">
                                <div className="page-error-boundary__help-box">
                                    ...
                                    <ul className="page-error-boundary__help-list">
                                        ...
                                        <li>Use the navigation buttons to go to a different page</li>
