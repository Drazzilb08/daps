...
export const DirListDragDropField = React.memo(({
    ...
    const handleChange = useCallback((newDirectories) => {
    ...
    const handleDragEnd = useCallback((event) => {
        ...
        if (active.id !== over.id) {
            const oldIndex = directoriesArray.findIndex((_, idx) => idx.toString() === active.id);
    ...
    const emptySecondaryMessage = field.empty_secondary_message || 'Click "Add Directory" to get started.';
