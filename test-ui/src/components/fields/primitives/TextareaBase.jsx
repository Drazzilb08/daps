...
export const TextareaBase = ({ 
  ...
  return (
    <textarea
      ...
      className={`field-textarea field-input-base field-input-typography field-input-layout touch-target w-full ${invalid ? 'is-invalid' : ''} ${disabled ? 'cursor-not-allowed' : ''} ${className}`.trim()}
      aria-describedby={ariaDescribedby}
      aria-invalid={ariaInvalid}
      {...textareaProps}
    />
