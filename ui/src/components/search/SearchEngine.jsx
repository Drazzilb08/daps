...
export default function SearchEngine({
    ...
    }, [searchAdapter, currentSource]); // Only depend on essential values
    
    // ===== SEARCH LOGIC =====
    const performSearch = useCallback((overrideTerm = undefined) => {
    ...
    useEffect(() => {
        ...
        applyFiltersAndSort();
    }, [activeFilters, currentSort]); // Only trigger on filter/sort changes, NOT on searchTerm changes
