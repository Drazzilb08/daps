...
export { assetsPluginConfig } from './AssetsPlugin';
export { gdrivePluginConfig } from './GdrivePlugin';
...
export const createSearchComponent = (pluginId, overrideConfig = {}) => {
    const PluginComponent = (props) => React.createElement(SimpleSearchPlugin, {
        pluginId,
        overrideConfig,
        ...props
    });
