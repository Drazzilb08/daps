...
export default function GridView({
    ...
    const { processedGroups, processedGroupOrder, flattenedItems } = useSearchView({
        results,
        groupBy,
        currentSort,
        priorityOrder,
    ...
    // Debug logging for flattening behavior
    useMemo(() => {
    ...
    }, [groupBy, processedGroups, processedGroupOrder, results.length]);
        ...
        (virtualRow, gridRows) => {
            ...
            if (virtualRow.index === 0) {
                console.log('GridView Virtualizer Status:', {
                    ...
                    virtualItemsCount: 'handled by VirtualizedContainer',
                    scrollElementHeight: resultsContainerRef?.current?.clientHeight || 'unknown',
                });
            }
