...
const ErrorBoundaryTest = () => {
    ...
    return (
        <div
            ...
            style={{ padding: '2rem', fontFamily: 'var(--font-family)' }}
        >
            ...
            <div style={{ marginBottom: '3rem' }}>
                ...
                <ErrorBoundary context="Test Component" onError={handleError}>
                    <ErrorThrowingComponent shouldThrow={genericError} errorType="Generic" />
                </ErrorBoundary>
            </div>

            <div style={{ marginBottom: '3rem' }}>
                <h2>2. Page Error Boundary</h2>
                <button onClick={() => setPageError(!pageError)} style={{ marginBottom: '1rem' }}>
                ...
                <PageErrorBoundary
                    ...
                    onError={handleError}
                >
                    <ErrorThrowingComponent shouldThrow={pageError} errorType="Page" />
                </PageErrorBoundary>
            </div>
            ...
            <div style={{ marginBottom: '3rem' }}>
                ...
                >
                    <ErrorThrowingComponent shouldThrow={featureError} errorType="Feature" />
                </FeatureErrorBoundary>
            </div>
            ...
            >
                ...
                <ul>
                    <li>
                        <strong>Generic Error Boundary:</strong> Shows retry and reload options
                    </li>
                    <li>
                        <strong>Page Error Boundary:</strong> Shows navigation and retry options
                    </li>
                    <li>
                        <strong>Feature Error Boundary:</strong> Shows retry, degraded mode, and
                        disable options
                    </li>
                </ul>
                <p>
                    <strong>Note:</strong> All errors are caught and reported to the
                    GlobalErrorProvider system.
                </p>
            </div>
        </div>
    );
